...
\-- 1. List every student’s student\_id, first\_name, last\_name, enrollment\_year, and enrollment\_status.
\-- 2. Find students who enrolled in a specific year, e.g. 2015.
\-- 3. Retrieve all students with enrollment\_status = 'transfer-in'.
